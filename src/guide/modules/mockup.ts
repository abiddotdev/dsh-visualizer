...
export const mockup: ModuleGuide = {
  ...
  detail: [
    ...
    '### Starter snippet',
    'One card on the gutter grid: label above input, primary action rightmost, radii and gaps taken from the measurements above rather than eyeballed:',
    '```svg\n<svg viewBox="0 0 320 160" width="100%" role="img" aria-label="Sign-in form card">\n  <rect x="0" y="0" width="320" height="160" rx="8" style="fill: var(--dsw-alias-background-secondary)"></rect>\n  <text x="20" y="32" style="fill: var(--dsw-alias-label-secondary); font: 400 12px system-ui">Email</text>\n  <rect x="20" y="40" width="280" height="36" rx="6" style="fill: var(--dsw-alias-background-primary)"></rect>\n  <rect x="212" y="104" width="88" height="36" rx="6" style="fill: var(--dsw-accent)"></rect>\n  <text x="256" y="127" text-anchor="middle" style="fill: var(--dsw-alias-label-on-accent); font: 500 13px system-ui">Sign in</text>\n</svg>\n```',
    '### Failure modes',
