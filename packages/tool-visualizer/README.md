...
Three primitive parameters — `title` (optional string), `height` (optional integer), `html` (required string, declared last) — plus the description in the generated [tool catalog](../../../docs/tool-catalog.md#deepseek-aidsh-tool-generativeui).
